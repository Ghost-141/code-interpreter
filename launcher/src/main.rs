...
fn is_allowed_guest_env_key(key: &str, egress_gateway_enabled: bool) -> bool {
    const ALLOW_EXACT: &[&str] = &[
        ...
        "SANDBOX_INPUT_CACHE_DIR",
        "SANDBOX_INPUT_CACHE_MAX_BYTES",
        "SANDBOX_LIMIT_OVERRIDES",
        "SANDBOX_LOG_LEVEL",
        "SANDBOX_MARKER_CACHE_TTL_SECONDS",
        ...
        "SANDBOX_PRIME_CONCURRENCY",
        "SANDBOX_PULL_THROUGH_CACHE",
...
mod tests {
    ...
    fn guest_env_allowlist_keeps_only_runner_runtime_vars() {
        for key in [
            ...
            "SANDBOX_EXECUTION_MANIFEST_PUBLIC_KEY",
            "SANDBOX_RUN_TIMEOUT",
            /* Caching knobs: unforwarded, they are set in .env, ignored by the
             * guest, and the operator sees no effect. */
            "SANDBOX_PRIME_CONCURRENCY",
            "SANDBOX_PULL_THROUGH_CACHE",
            "SANDBOX_INPUT_CACHE_DIR",
            "SANDBOX_INPUT_CACHE_MAX_BYTES",
